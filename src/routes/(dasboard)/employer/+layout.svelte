...
// end
  ...
  const menu = [
    ...
    // {
    //   name: "Guest Check In",
    //   url: "/employer/guest-check-in",
    //   icon: "fluent:guest-16-filled",
    //   active: false
    // },
    {
      name: "Check In",
      url: "/employer/check-in",
      icon: "lets-icons:in",
      active: false
    },
    {
      name: "Check Out",
      url: "/employer/check-out",
      icon: "lets-icons:out",
      active: false
    }
  ];
    ...
    <div>
      ...
      <Modal bind:open={popupModal} size="xs" autoclose>
        <div class="text-center">
          ...
          <GradientButton color="red" class="mr-2" on:click={signOut}>Yes, I'm sure</GradientButton>
...
<div class="admin-content flex">
  ...
  <div class="admin-content-box grow overflow-hidden" style="--deg: {degString}; --gradient-1:{colors[0]}; --gradient-2:{colors[1]};">
