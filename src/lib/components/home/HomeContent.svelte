<script>
    const teammates = [
        ...
        // Thêm các teammates khác tương tự ở đây
    ];
</script>
...
<div class="home-container">
    ...
    <div class="home-content w-full">
        <h1 class="content-heading benefit-heading">
            What do you get from us?
        </h1>
        <div
            class="content-benefit container grid md:grid-cols-2 sm:grid-cols-1 gap-3"
        >
            <div class="benefit benefit-content">
                <h3>We love and care for your pet as its own.</h3>
                <p>
                    We make your friend even better - dedicated and professional
                    pet care service. Here, we love and care for your pet as if
                    it were our own. Love and care is the motto we always adhere
                    to in every aspect of our work.
                    <br /><br />
                    With a team of passionate and experienced staff, we are committed
                    to ensuring that your pet is cared for with the utmost care and
                    safety. We understand the importance of a loving companion, and
                    as such, we always consider each individual case to best meet
                    each furry baby's needs.
                    <br /><br />
                    On site, you can have complete peace of mind and peace of mind
                    when leaving your pet with us. With a comfortable and comfortable
                    environment, we guarantee your pet will have a pleasant and peaceful
                    experience while staying here.
                    <br /><br />
                    Let us share our love and passion for your pet, and together
                    create memorable and happy memories for your family. We hope
                    that you will feel secure and satisfied when choosing our service.
                    Come join us today and share the love with your pet!
                </p>
            </div>
    ...
    <!-- Our team -->
    <div class="home-content ourteam w-full">
        <h1 class="content-heading ourteam-heading">Our team</h1>
        <p class="content-subheading">
            We are committed to ensuring that your pet is cared for with the
        ...
        <div class="ourteam-content">
            <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-4">
                {#each teammates as docter}
                    <div
                        class="docter-item max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                    >
                        <a href="/">
                            <img
                                class="docter-image rounded-t-lg"
                                src={docter.image}
                                alt={docter.name}
                            />
                        </a>
                        <div class="p-5">
                            ...
                            <p
                                class="docter-note mb-3 font-normal text-gray-700 dark:text-gray-400"
                            >
                                {docter.note}
                            </p>
                            ...
                            <a
                                href="/"
                                class="docter-btn inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            >
                                Read more
                                <svg
...
<style>
    ...
    .benefit-heading {
        background: linear-gradient(to right, #30cfd0 0%, #fa4300 100%);
