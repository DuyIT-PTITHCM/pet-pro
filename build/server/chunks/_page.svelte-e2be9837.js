import { c as create_ssr_component, v as validate_component, e as escape, b as each, a as add_attribute, i as createEventDispatcher } from './ssr-33dc266f.js';
import { s as subscribe, a as compute_slots, n as null_to_empty } from './utils-83bdc9a3.js';
import { I as Icon } from './Icon-2596fab7.js';
import { twMerge } from 'tailwind-merge';
import { t as t2 } from './index-11f981df.js';
import 'siema';
import { r as readable } from './index2-afe1f66f.js';
...
const css$5 = {
  code: ".carousel.svelte-j95la.svelte-j95la{position:relative;width:100%;justify-content:center;align-items:center}.slides.svelte-j95la.svelte-j95la{height:400px !important}button.svelte-j95la.svelte-j95la{position:absolute;width:40px;height:40px;top:50%;z-index:50;margin-top:-20px;border:none;background-color:transparent}button.svelte-j95la.svelte-j95la:focus{outline:none}.left.svelte-j95la.svelte-j95la{left:2vw}.right.svelte-j95la.svelte-j95la{right:2vw}ul.svelte-j95la.svelte-j95la{list-style-type:none;position:absolute;display:flex;justify-content:center;width:100%;margin-top:-30px;padding:0}ul.svelte-j95la li.svelte-j95la{margin:6px;border-radius:100%;background-color:rgba(255, 255, 255, 0.5);height:8px;width:8px}ul.svelte-j95la li.svelte-j95la:hover{background-color:rgba(255, 255, 255, 0.85)}ul.svelte-j95la li.active.svelte-j95la{background-color:rgba(255, 255, 255, 1)}",
  map: null
};
const CarouselCustom = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { dots = true } = $$props;
  let { controls: controls2 = true } = $$props;
  ...
  totalDots = [];
  $$unsubscribe_time();
  return `<div class="carousel svelte-j95la"><div class="${"slides " + escape(classList, true) + " svelte-j95la"}"${add_attribute("this", siema, 0)}>${slots.default ? slots.default({}) : ``}</div> ${controls2 ? `<button class="left svelte-j95la" aria-label="left">${slots["left-control"] ? slots["left-control"]({}) : ``}</button> <button class="right svelte-j95la" aria-label="right">${slots["right-control"] ? slots["right-control"]({}) : ``}</button>` : ``} ${dots ? `<ul class="svelte-j95la">${each({ length: totalDots }, (_, i) => {
    return `<li class="${escape(null_to_empty(isDotActive(currentIndex, i) ? "active" : ""), true) + " svelte-j95la"}"></li>`;
  })}</ul>` : ``} </div>`;
});
const css$4 = {
  code: ".home-content.svelte-186us8t{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:50px;position:relative}.content-heading.svelte-186us8t{font-size:34px;margin-bottom:20px;font-weight:600}.clientsay-box-content.svelte-186us8t{background-image:url(/images/homepage/lientsaybg.jpg);background-position:center;background-repeat:no-repeat;background-size:cover}.clientsay-client.svelte-186us8t{text-align:center}.client-avatar.svelte-186us8t{width:140px;height:140px;object-fit:cover;border-radius:50%;box-shadow:0 4px 10px black}.client-message.svelte-186us8t{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:5;overflow:hidden;text-shadow:0 0 10px black}",
  map: null
};
let controls = false;
const ClientSay = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="home-content clientsay-box-content bg-fixed w-full min-h-screen relative svelte-186us8t"><div class="absolute w-full h-full bg-white dark:bg-black z-10 bg-opacity-10 dark:bg-opacity-40"></div>  <h1 class="content-heading clientsay-heading text-white z-10 svelte-186us8t" data-svelte-h="svelte-yo5s5">What our clients say about us</h1> <div class="content-clientsa w-full z-10">${validate_component(CarouselCustom, "CarouselCustom").$$render($$result, { autoplay: 1e4, controls, perPage: 1 }, {}, {
    "right-control": () => {
    ...
    default: () => {
      return `${each(clientsays, (clent, index) => {
        return `<div class="clientsay-client md:w-2/4 sm:w-full mx-auto svelte-186us8t"><img class="client-avatar mx-auto svelte-186us8t"${add_attribute("src", clent.avatar, 0)}${add_attribute("alt", clent.name, 0)}> <p class="mb-2 text-2xl font-bold tracking-tight text-white">${escape(clent.name)}</p> <p class="mb-2 text-md font-bold tracking-tight text-white">${escape(clent.address)}</p> <p class="client-message mb-10 font-normal text-gray-100 2xl:text-xl xl:text-xl md:text-xl sm:text-lg text-lg svelte-186us8t">${escape(clent.message)}</p> </div>`;
      })}`;
    }
  })}</div> </div>`;
});
const css$3 = {
  code: ".benefit-image-1.svelte-1xcudyy{animation:svelte-1xcudyy-moving_1 ease 6s infinite;border-radius:50%}.benefit-image-2.svelte-1xcudyy{animation:svelte-1xcudyy-moving_2 ease 6s infinite;border-radius:50%;position:absolute}@keyframes svelte-1xcudyy-moving_1{0%{transform:rotateY(0deg);z-index:1}50%{transform:rotateY(180deg);z-index:0}100%{transform:rotateY(0deg);z-index:1}}@keyframes svelte-1xcudyy-moving_2{0%{transform:rotateY(0deg);z-index:0}50%{transform:rotateY(180deg);z-index:1}100%{transform:rotateY(0deg);z-index:0}}",
  map: null
};
const Benefit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="relative w-full min-h-screen"><div class="absolute w-full h-full top-0 z-10 text-center"><div class="flex justify-center items-center flex-col h-full text-black dark:text-white "><h2 class="2xl:text-6xl xl:text-6xl md:text-5xl sm:text-4xl text-3xl font-bold shadow-black mb-10 brightness-200 uppercase">${escape($t("homepage.benefit"))}</h2> <div class="2xl:w-2/4 xl:w-2/4 md:w-4/5 sm:w-9/12 w-full 2xl:text-xl xl:text-xl md:text-xl sm:text-lg text-lg"><p class="w-full">${escape($t("homepage.benefitDesc1"))} <br><br> ${escape($t("homepage.benefitDesc2"))}</p></div></div></div> <div class="w-full h-screen flex items-center justify-center relative drop-shadow-xl" data-svelte-h="svelte-147zd6b"><img src="/images/homepage/benefit.jpg" alt="benefit" class="benefit-image-1 animate-pulse h-3/4 svelte-1xcudyy"> <img src="/images/homepage/benefit2.jpg" alt="benefit" class="benefit-image-2 animate-pulse h-3/4 svelte-1xcudyy"> <div class="absolute w-full h-full bg-white dark:bg-black z-10 bg-opacity-30 dark:bg-opacity-40"></div></div> </div>`;
});
...
const css$2 = {
  code: '.content-bg.svelte-1opx627{background-image:url("/images/homepage/ourteam.jpg")}.docter-note.svelte-1opx627{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;overflow:hidden}',
  map: null
};
const OurTeam = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="content-bg bg-black-50 bg-image-center bg-no-repeat bg-cover bg-fixed w-full min-h-screen flex flex-col justify-center items-center p-12 relative svelte-1opx627"><h1 class="text-3xl font-bold mt-20 text-white" data-svelte-h="svelte-1kl2qd1">Our team</h1> <p class="text-white m-3" data-svelte-h="svelte-pn7mkv">We are committed to ensuring that your pet is cared for with the utmost care and safety.</p> <div><div class="grid md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2 gap-4">${each(teammates, (docter) => {
    return `<div class="relative max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"><a href="/"><img class="h-64 w-full object-fit-cover rounded-t-lg"${add_attribute("src", docter.image, 0)}${add_attribute("alt", docter.name, 0)}></a> <div class="p-5"><a href="/"><h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${escape(docter.name)}</h5></a> <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">${escape(docter.slogan)}</p> <p class="docter-note mb-3 font-normal text-gray-700 dark:text-gray-400 svelte-1opx627">${escape(docter.note)}</p> <div style="height: 50px;"></div></div> <div class="w-full bottom-5 absolute flex justify-center items-center">${validate_component(Button, "Button").$$render(
      $$result,
      {
        content: "Read more",
...
const css$1 = {
  code: ".text-note.svelte-1fojw8t.svelte-1fojw8t{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;overflow:hidden}.ourservice-service.svelte-1fojw8t:hover .service-desc.svelte-1fojw8t{height:70px;transition:height .4s}.ourservice-service.svelte-1fojw8t:hover img.svelte-1fojw8t{filter:blur(8px);transition:filter ease .4s}",
  map: null
};
const OurService = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex flex-col justify-center items-center p-10 relative w-full min-h-screen"><h1 class="text-3xl mb-5 font-semibold dark:text-white" data-svelte-h="svelte-113kl75">Our Services</h1> <p class="mb-4 dark:text-white" data-svelte-h="svelte-1701gnf">Pets bring us joy and happiness, and we have a responsibility to take good care of them.</p> <div class="ourservice xl:w-4/5 md:w-11/12 mx-auto grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-5">${each(services, (service) => {
    return `<div class="ourservice-service h-72 rounded-lg overflow-hidden text-center flex items-center justify-center flex-col relative svelte-1fojw8t"><img class="w-full h-72 object-cover svelte-1fojw8t"${add_attribute("src", service.image, 0)} alt=""> <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center flex-col text-white"><h3 class="text-2xl drop-shadow-lg shadow-black brightness-200 font-extrabold px-4 py-2 bg-opacity-50 dark:bg-opacity-40 text-white rounded-full">${escape(service.name)}</h3> <p class="service-desc my-2 mx-4 h-0 text-note drop-shadow-lg shadow-black brightness-200 svelte-1fojw8t">${escape(service.description)}</p> ${validate_component(Button, "Button").$$render(
      $$result,
      {
        content: "Read more",
        icon: "icon-park-solid:right-two"
...
const css = {
  code: ".home-content.svelte-1d2bj11.svelte-1d2bj11{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:50px;position:relative}.content-heading.svelte-1d2bj11.svelte-1d2bj11{font-size:34px;margin-bottom:20px;font-weight:600;text-transform:capitalize}.best-product.svelte-1d2bj11.svelte-1d2bj11{width:100%;padding:20px 10px;line-height:1.2}.best-product.svelte-1d2bj11 .svelte-1d2bj11{margin:4px}.best-product.svelte-1d2bj11 img.svelte-1d2bj11{width:100%;height:250px;object-fit:cover}.best-product.svelte-1d2bj11 h3.svelte-1d2bj11{text-align:center;margin:10px;font-size:18px;font-weight:700}.product-message.svelte-1d2bj11.svelte-1d2bj11{font-size:14px;text-align:justify;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;overflow:hidden}.rank-price.svelte-1d2bj11.svelte-1d2bj11{display:flex;align-items:center;justify-content:space-around}.rank.svelte-1d2bj11.svelte-1d2bj11{display:flex;align-items:center;justify-content:center}.rank.svelte-1d2bj11 .svelte-1d2bj11{margin:0 10px}.addccart.svelte-1d2bj11.svelte-1d2bj11{width:100%;display:flex;align-items:center;justify-content:center}.price.svelte-1d2bj11.svelte-1d2bj11{font-size:20px}",
  map: null
};
const BestSeller = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_time();
  return `<div class="home-content w-full svelte-1d2bj11"><h1 class="content-heading dark:text-white svelte-1d2bj11" data-svelte-h="svelte-1w9xj2e">favorite products</h1> <div class="selling-content"><div class="grid md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2 gap-4"> ${each(favoriteproducts, (product, index) => {
    return `<div class="best-product bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 svelte-1d2bj11"><img${add_attribute("src", product.image, 0)}${add_attribute("alt", product.name, 0)} class="svelte-1d2bj11"> <h3 class="svelte-1d2bj11">${escape(product.name)}</h3> <p class="product-message svelte-1d2bj11"><!-- HTML_TAG_START -->${product.description}<!-- HTML_TAG_END --></p> <div class="rank-price svelte-1d2bj11"><div class="rank svelte-1d2bj11">${each(Array(product.star), (_, i) => {
      return `<div class="star svelte-1d2bj11" data-svelte-h="svelte-1ywacup">⭐</div>`;
    })}</div> <div class="price svelte-1d2bj11"><p class="svelte-1d2bj11">${escape(product.price)} $</p> </div></div> <div class="addccart svelte-1d2bj11">${validate_component(Button, "Button").$$render(
      $$result,
      {
        content: "Add to cart",
        classOrther: "",
...
//# sourceMappingURL=_page.svelte-e2be9837.js.map
