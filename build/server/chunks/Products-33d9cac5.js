import { c as is_promise, n as noop, d as compute_rest_props } from './utils-ea986cb1.js';
import { c as create_ssr_component, b as each, v as validate_component, e as escape, a as add_attribute } from './ssr-ca1a55ab.js';
        ...
        return ` <div class="relative">${product.discount > 0 ? `<div class="absolute top-0 left-0 bg-red-500 text-white px-2 py-1 rounded-tr-md rounded-bl-2xl border-l-8 border-t-4 border-red-600 -ml-2 transform z-10 animate-bounce">${escape(product.discount)}% discount
          ...
          {},
          {
            default: () => {
              return `${validate_component(CarouselCustom, "CarouselCustom").$$render($$result, { perPage: 1, duration: 400 }, {}, {
                default: () => {
                  return `${each(res, (path, i) => {
                    return `<img${add_attribute("src", !path ? "/images/logo.png" : `${host}/` + path, 0)} class="rounded w-full mb-4 h-[350px] object-cover"${add_attribute("alt", product?.productName, 0)}>`;
                  })} `;
                }
              ...
              )} ${validate_component(Button, "Button").$$render($$result, { outline: true, class: "text-2xl" }, {}, {
                default: () => {
...
export { CardPlaceholder as C, Products as P };
//# sourceMappingURL=Products-33d9cac5.js.map
