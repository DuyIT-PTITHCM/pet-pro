import { c as create_ssr_component, v as validate_component, e as escape, a as each, b as add_attribute } from './ssr-01008541.js';
...
import { T as Tabs, a as TabItem } from './CreateSeo-cd6b1a22.js';
                ...
                default: () => {
                  return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true, title: "Seo" }, {}, {
                    ...
                    default: () => {
                      ...
                      })}</div></div></div>  <div class="py-[20px] justify-center"><h3 data-svelte-h="svelte-dsfzlm">Content Posts</h3><br> <div class="dark:text-gray-100"><!-- HTML_TAG_START -->${product?.post?.content}<!-- HTML_TAG_END --></div></div>`;
                    }
                  })}`;
                }
              }
...
//# sourceMappingURL=_page.svelte-9cd11a54.js.map
