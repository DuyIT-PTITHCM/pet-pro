import { c as compute_rest_props, d as compute_slots } from './utils-4ce9e277.js';
import { c as create_ssr_component, g as getContext, b as add_attribute, d as spread, h as escape_object, f as escape_attribute_value, e as escape, s as setContext, v as validate_component } from './ssr-01008541.js';
import { w as writable } from './index-cefc8762.js';
import { twMerge } from 'tailwind-merge';
import './RepositoryFactory-9eb26519.js';
import 'js-cookie';
import { I as Icon } from './Indicator.svelte_svelte_type_style_lang-d22f5597.js';
import { F as Fileupload } from './Fileupload-31c680ce.js';
import { W as Wrapper } from './Wrapper-97dcdf2f.js';
...
const CreateSeo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="${escape(divClass, true) + " bg-white dark:bg-slate-800 dark:text-white shadow-md rounded h-full"}"><h1 class="text-[34px] py-[10px] uppercase text-center font-bold col-span-full" data-svelte-h="svelte-1bkzpj1">seo edit</h1>  <div class="px-3 mb-6 md:mb-0"><label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2 text-[14px] py-[10px]" for="metaTitle" data-svelte-h="svelte-14u5ve">Meta Title</label> <input class="appearance-none dark:bg-gray-700 block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="metaTitle" type="text" placeholder="Input Meta Description"${add_attribute("value", seo.metaTitle, 0)}></div> <div class="px-3"><label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2 text-[14px] py-[10px]" for="metaDescription" data-svelte-h="svelte-13ig0ly">Meta Description</label> ${validate_component(Textarea, "Textarea").$$render(
      $$result,
      {
