...
import { c as create_ssr_component, g as getContext, v as validate_component, e as escape, d as spread, h as escape_object, f as escape_attribute_value, a as add_attribute, b as each } from './ssr-33dc266f.js';
...
const css = {
  code: ".toast-container.svelte-1in8duy{z-index:1000;position:fixed;top:100px;right:1rem;display:flex;flex-direction:column-reverse;align-items:flex-end}.toast.svelte-1in8duy{color:white;padding:1rem;border-radius:0.25rem;display:flex;align-items:center;gap:1rem;margin-bottom:0.5rem;animation:svelte-1in8duy-slide-in 0.5s linear forwards}.success.svelte-1in8duy{background:#a8ff78;background:-webkit-linear-gradient(to right, #78ffc2, #a8ff78);background:linear-gradient(to right, #00ffb3, #a8ff78)}.error.svelte-1in8duy{background:#ee0979;background:-webkit-linear-gradient(to right, #ee0979, #ff6a00);background:linear-gradient(to right, #ee0979, #ff6a00)}.info.svelte-1in8duy{background:#fff878;background:-webkit-linear-gradient(to right, #0077ff, #fff478);background:linear-gradient(to right, #00ffff, #166bff)}.warning.svelte-1in8duy{background:#fff878;background:-webkit-linear-gradient(to right, #78ffd6, #fff478);background:linear-gradient(to right, #ffe678, #ffea00)}@keyframes svelte-1in8duy-slide-in{from{transform:translateX(100%)}to{transform:translateX(0%)}}@keyframes svelte-1in8duy-moving{0%{box-shadow:0 0 10px #01ffb3;rotate:0deg}100%{box-shadow:0 0 10px #ff0101;rotate:360deg}}",
  map: null
};
const ToastCustom = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="toast-container svelte-1in8duy">${each(toasts, (toast) => {
    return `${toast.visible ? `<div class="${"toast " + escape(messageType, true) + " svelte-1in8duy"}"><p class="flex items-center">${validate_component(Icon, "Icon").$$render(
      $$result,
      {
        class: "text-3xl",
...
//# sourceMappingURL=ToastCustom-5fd57075.js.map
