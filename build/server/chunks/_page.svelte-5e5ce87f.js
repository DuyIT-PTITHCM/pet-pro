import { c as create_ssr_component, v as validate_component, d as spread, h as escape_object, f as escape_attribute_value } from './ssr-8dc8d8d7.js';
import { G as GradientButton } from './GradientButton-1753a311.js';
import './Icon-c5f05f08.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-703ozx_START -->${$$result.title = `<title>
        Sing Up
    </title>`, ""}<!-- HEAD_svelte-703ozx_END -->`, ""} ${validate_component(SignUp, "SignUp").$$render($$result, {}, {}, {})} ${validate_component(ToastError, "ToastError").$$render($$result, {}, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-5e5ce87f.js.map
