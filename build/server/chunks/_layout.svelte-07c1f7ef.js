...
import { F as Frame, T as ToolbarButton } from './CloseButton-b88a28b7.js';
...
import { P as Popover } from './Popover-20e7c244.js';
  ...
  do {
    ...
    $$rendered = `<div class="w-full relative"><div class="w-full" style="${"height: " + escape(heightHeader, true) + "px;"}"></div> <div class="w-full fixed top-0 z-50">${validate_component(Navbar, "Navbar").$$render($$result, { class: "shadow-md" }, {}, {
      default: ({ hidden, toggle }) => {
        ...
        })} <div class="flex items-center md:order-1 lg:order-2"><a href="/login" title="Login"${add_attribute("class", classBtn, 0)}>${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:user", class: "scale-150" }, {}, {})}</a> <a class="${"relative " + escape(classBtn, true)}" href="/gio-hang">${validate_component(Icon, "Icon").$$render(
          $$result,
          {
...
//# sourceMappingURL=_layout.svelte-07c1f7ef.js.map
