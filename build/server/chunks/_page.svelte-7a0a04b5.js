import { c as create_ssr_component, v as validate_component, a as add_attribute } from './ssr-33dc266f.js';
import { B as Button } from './Button-bc7f9417.js';
import './Icon-2596fab7.js';
import { D as DarkMode } from './Wrapper-dcaf300d.js';
import { L as Label, C as Checkbox } from './Checkbox-4a4327c1.js';
import { I as Input, H as Helper, T as ToastCustom } from './ToastCustom-5fd57075.js';
import 'js-cookie';
...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })} <a href="/signup" class="text-primary-600 dark+:text-primary-500 hover:underline font-bold text-sm text-right w-full block" data-svelte-h="svelte-1kfjhtd">Sign up for Pet One</a></form></div></div> <div class="absolute w-full h-full dark:brightness-50 transition-all" data-svelte-h="svelte-1tfs45u"><img class="w-full h-full object-cover"${add_attribute("src", "/images/loginbg.jpg", 0)} alt=""></div></div> ${validate_component(ToastCustom, "ToastCustom").$$render(
      $$result,
...
//# sourceMappingURL=_page.svelte-7a0a04b5.js.map
