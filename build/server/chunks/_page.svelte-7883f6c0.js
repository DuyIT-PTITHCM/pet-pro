...
import 'js-cookie';
import { C as CarouselCustom } from './CarouselCustom-65f35f2b.js';
import { P as Products } from './Products-33d9cac5.js';
...
import { H as Hr } from './Hr-f8de6fa8.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })} <div class="mb-4" id="note"><!-- HTML_TAG_START -->${product.notes}<!-- HTML_TAG_END --></div></div> <div>${validate_component(Hr, "Hr").$$render($$result, { classHr: "my-8 w-64 h-1", icon: true }, {}, {
      default: () => {
        return `${validate_component(Icon, "Icon").$$render(
          $$result,
          {
...
//# sourceMappingURL=_page.svelte-7883f6c0.js.map
