...
import { L as Loading, G as GradientButton } from './GradientButton-5f654270.js';
import { D as DarkMode } from './DarkMode-2c799f18.js';
import { t as title, d as description } from './meta-9b043ecf.js';
import { l as loadingState } from './loading-77099a3c.js';
import { A as Avatar, D as Dropdown, a as DropdownHeader, b as DropdownItem, c as DropdownDivider } from './DropdownItem-3efdcb2b.js';
import { M as Modal, F as Frame, T as ToolbarButton } from './Modal-1552c263.js';
...
const BASE_API = "http://103.142.26.42/api/v1.0";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-16u4lqv_START -->${$$result.title = `<title>${escape($title)}</title>`, ""}<meta name="description"${add_attribute("content", $description, 0)}><!-- HEAD_svelte-16u4lqv_END -->`, ""} ${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main>${slots.default ? slots.default({}) : ``}</main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})} ${validate_component(Loading, "Loading").$$render($$result, {}, {}, {})}`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-6df6a7c6.js.map
