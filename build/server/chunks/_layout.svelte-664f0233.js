    ...
    $$rendered = `<div class="w-full relative"><div class="w-full" style="${"height: " + escape(heightHeader, true) + "px;"}"></div> <div class="w-full fixed top-0 z-50">${validate_component(Navbar, "Navbar").$$render($$result, { class: "shadow-md" }, {}, {
      default: ({ hidden, toggle }) => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
          ...
          {},
          {}
        )}</a> <a class="relative p-4" href="/gio-hang">${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:cart", class: "scale-150" }, {}, {})} <span class="absolute top-0 right-0 rounded-xl h-[23px] w-[23px] bg-primary-600 text-white flex justify-center items-center p-2" data-svelte-h="svelte-w7calf">10</span></a> ${validate_component(DarkMode, "DarkMode").$$render($$result, { btnClass }, {}, {})} ${validate_component(NavHamburger, "NavHamburger").$$render(
          $$result,
          {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div id="ontop"></div> <div class="min-h-screen flex flex-col">${data.menu.length > 0 ? `${validate_component(Header, "Header").$$render(
      ...
      {}
    )}` : ``} <main>${slots.default ? slots.default({}) : ``}</main> <div class="mt-auto">${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div> ${validate_component(Loading, "Loading").$$render($$result, {}, {}, {})}</div> <a href="#ontop" class="p-4 bg-black bottom-0 right-0 fixed text-white rounded-full text-xl font-bold mb-3 mr-3 animate-spin">${validate_component(Icon, "Icon").$$render($$result, { icon: "bxs:up-arrow" }, {}, {})}</a>`;
  } while (!$$settled);
  return $$rendered;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-664f0233.js.map
