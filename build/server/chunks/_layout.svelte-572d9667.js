import { c as create_ssr_component, v as validate_component, e as escape, a as add_attribute, b as each, d as spread, f as escape_attribute_value, h as escape_object, g as getContext, s as setContext } from './ssr-e41dcf02.js';
...
import { s as slide } from './index3-4d2710df.js';
...
import { T as ToolbarButton } from './CloseButton-d467ac5d.js';
...
import { P as Popover } from './Popover-ac81aef7.js';
import { L as LanguageSelect } from './LanguageSelect-dc360209.js';
import { t as t2 } from './index2-28f799b2.js';
import { p as page } from './stores-7ed7e36a.js';
import { c as cartItemQuantity } from './cart-5baadeca.js';
import { B as Button } from './Button-921a77e0.js';
import './loading-6e9dcca6.js';
import './toastError2-475540f6.js';
import './Popper-e982371d.js';
  ...
  do {
    ...
    $$rendered = `<div class="w-full relative"><div class="w-full" style="${"height: " + escape(heightHeader, true) + "px;"}"></div> <div class="w-full fixed top-0 z-50">${validate_component(Navbar, "Navbar").$$render($$result, { class: "shadow-md" }, {}, {
      default: ({ hidden, toggle }) => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        ...
        })} <div class="flex items-center md:order-1 lg:order-2"><a href="/login" title="Login"${add_attribute("class", classBtn, 0)}>${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:user", class: "scale-150" }, {}, {})}</a> <a href="/profile" title="Login"${add_attribute("class", classBtn, 0)}>${validate_component(Icon, "Icon").$$render(
          $$result,
          {
            icon: "mdi:user",
            class: "scale-150 bg-pink-300"
          },
          {},
          {}
        )}</a> <a class="${"relative " + escape(classBtn, true)}" href="/gio-hang">${validate_component(Icon, "Icon").$$render(
          $$result,
          {
          ...
          {},
          {}
        )} <span class="absolute top-0 right-0 rounded-xl h-[23px] w-[23px] bg-primary-600 text-white flex justify-center items-center p-2 text-base">${escape(cartQuantity ? cartQuantity : 0)}</span></a> ${validate_component(DarkMode, "DarkMode").$$render($$result, { btnClass: classBtn }, {}, {})} ${validate_component(NavHamburger, "NavHamburger").$$render(
          $$result,
          {
...
//# sourceMappingURL=_layout.svelte-572d9667.js.map
