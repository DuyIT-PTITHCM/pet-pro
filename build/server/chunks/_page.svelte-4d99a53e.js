...
import { S as Slide, I as Indicator, C as Caption, T as Thumbnail } from './Indicator-f157ece8.js';
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  twMerge(divClass, $$props.classDiv);
  ...
  let { slideClass = "flex items-center justify-center h-full w-full" } = $$props;
  ...
  return `  <div${add_attribute("id", id, 0)} class="relative" role="button" aria-label="Draggable Carousel" tabindex="0"${add_attribute("this", carouselDiv, 0)}><div${add_attribute("style", `transform: translateX(${percentOffset}%)`, 0)}${add_attribute(
    "class",
    twJoin(divClass, {
      "transition-transform": activeDragGesture === void 0
    }),
    0
      ...
      default: () => {
        return `${validate_component(Carousel, "Carousel").$$render(
          $$result,
          {
            ...
            slideClass: "w-full",
            imgClass: "w-full h-[400px] object-cover",
            showCaptions: false,
            showThumbs: false
          },
          {},
          {}
        )} <div class="px-5 pb-5"><a href="${"/san-pham/" + escape(product.slug, true)}"><h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white py-4">${escape(product?.productName)}</h5> <p class="tracking-tight text-gray-900 dark:text-white line-clamp-2 min-h-[50px]">${escape(product.description)}</p></a> <div class="flex justify-between items-center">${validate_component(Rating, "Rating").$$render(
          $$result,
          {
            rating: 4,
            size: 24,
          ...
          {},
          {}
        )} <span class="text-xl font-bold text-gray-900 dark:text-white">${escape(formatCurrency(product?.price))}</span></div> <div class="flex float-right">${validate_component(Button, "Button").$$render($$result, { class: "mr-1 text-2xl", href: "/" }, {}, {
          default: () => {
...
//# sourceMappingURL=_page.svelte-4d99a53e.js.map
