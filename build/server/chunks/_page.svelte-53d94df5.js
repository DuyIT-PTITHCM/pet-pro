import { c as create_ssr_component, v as validate_component, e as escape, b as each, a as add_attribute, i as createEventDispatcher } from './ssr-0e636c26.js';
import { v as validate_store, s as subscribe, a as compute_slots, n as null_to_empty } from './utils-f848b3c2.js';
import { I as Icon } from './Icon-7c5b6750.js';
import { twMerge } from 'tailwind-merge';
import { t as t2 } from './index-6d216173.js';
import 'siema';
import { r as readable } from './index2-042bed90.js';
...
const Banner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="w-full h-screen home-banner overflow-hidden relative">${validate_component(CarouselTransition, "CarouselTransition").$$render(
    $$result,
    {
      images,
...
const ClientSay = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="home-content clientsay-box-content bg-fixed w-full h-screen relative s-JhldzLS1wePR"><div class="absolute w-full h-full bg-white dark:bg-black z-10 bg-opacity-10 dark:bg-opacity-40"></div>  <h1 class="content-heading clientsay-heading text-white z-10 s-JhldzLS1wePR" data-svelte-h="svelte-yo5s5">What our clients say about us</h1> <div class="content-clientsa w-full z-10">${validate_component(CarouselCustom, "CarouselCustom").$$render($$result, { autoplay: 1e4, controls, perPage: 1 }, {}, {
    "right-control": () => {
...
const Benefit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="relative w-full h-screen"><div class="absolute w-full h-full top-0 z-50 text-center"><div class="flex justify-center items-center flex-col h-full text-black dark:text-white "><h2 class="2xl:text-6xl xl:text-6xl md:text-5xl sm:text-4xl text-3xl font-bold drop-shadow-lg shadow-black mb-10 brightness-200 uppercase">${escape($t("homepage.benefit"))}</h2> <div class="2xl:w-2/4 xl:w-2/4 md:w-4/5 sm:w-9/12 w-full 2xl:text-xl xl:text-xl md:text-xl sm:text-lg text-lg"><p class="w-full">${escape($t("homepage.benefitDesc1"))} <br><br> ${escape($t("homepage.benefitDesc2"))}</p></div></div></div> <div class="w-full h-screen flex items-center justify-center relative drop-shadow-xl"><img src="/images/homepage/benefit.jpg" alt="benefit" class="benefit-image-1 animate-pulse h-3/4 s-bZk3apZuEcA5"> <img src="/images/homepage/benefit2.jpg" alt="benefit" class="benefit-image-2 animate-pulse h-3/4 s-bZk3apZuEcA5"> <div class="absolute w-full h-full bg-white dark:bg-black z-10 bg-opacity-30 dark:bg-opacity-40"></div></div> </div>`;
});
...
const OurService = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="home-content w-full h-screen s-fSMKkQU_OXK-"><h1 class="content-heading dark:text-white s-fSMKkQU_OXK-" data-svelte-h="svelte-1m0k6h6">Our Services</h1> <p class="mb-4 dark:text-white" data-svelte-h="svelte-1701gnf">Pets bring us joy and happiness, and we have a responsibility to take good care of them.</p> <div class="ourservice xl:w-4/5 md:w-11/12 mx-auto grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-5">${each(services, (service) => {
    return `<div class="ourservice-service s-fSMKkQU_OXK-"><img class="service-image s-fSMKkQU_OXK-"${add_attribute("src", service.image, 0)} alt=""> <div class="service-control s-fSMKkQU_OXK-"><h3 class="text-2xl drop-shadow-lg shadow-black brightness-200 font-bold px-4 py-2 bg-slate-100 dark:bg-black bg-opacity-50 dark:bg-opacity-40 text-black dark:text-white rounded-full">${escape(service.name)}</h3> <p class="service-desc text-note drop-shadow-lg shadow-black brightness-200 s-fSMKkQU_OXK-">${escape(service.description)}</p> ${validate_component(Button, "Button").$$render(
      $$result,
      {
        content: "Read more",
        icon: "icon-park-solid:right-two"
...
//# sourceMappingURL=_page.svelte-53d94df5.js.map
