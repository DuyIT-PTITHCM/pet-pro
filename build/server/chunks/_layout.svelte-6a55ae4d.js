                ...
                return `${validate_component(NavLi, "NavLi").$$render($$result, { nonActiveClass: "" }, {}, {
                  default: () => {
                    return `<div class="parent-menu relative w-full"><div class="flex items-center p-3"><button class="${"cursor-pointer w-full h-full " + escape(
                      ...
                      true
                    )}">${escape($t(item.name))}</button> ${item?.subMenus && item?.subMenus?.length > 0 ? `<button class="ml-2 px-1">${validate_component(Icon, "Icon").$$render(
                      $$result,
                      {
                      ...
                      return `<button class="${"block w-full p-4 hover:bg-slate-600 duration-300 hover:text-white " + escape(
...
//# sourceMappingURL=_layout.svelte-6a55ae4d.js.map
