import { w as writable, d as derived } from './index-92a6d03f.js';
import { g as get_store_value } from './utils-a4f7b281.js';
...
const config = {
  loaders: [
    ...
    },
    {
      locale: "en",
      key: "products",
      loader: async () => (await import('./products-d73e15be.js')).default
    },
    {
      locale: "en",
      key: "seo",
    ...
    },
    {
      locale: "vi",
      key: "products",
      loader: async () => (await import('./products2-8c45cc64.js')).default
    },
    {
      locale: "vi",
      key: "seo",
...
//# sourceMappingURL=index2-be839c26.js.map
