...
import { b as Textarea, T as Tabs, a as TabItem, C as CreateSeo } from './CreateSeo-cc8f9de3.js';
...
const CreateProduct = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="bg-white dark:bg-slate-800 dark:text-white rounded h-full py-[10px] my-3"><div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 p-4"><h1 class="text-[34px] py-[10px] uppercase text-center font-bold col-span-full">${escape(title)}</h1> <div class="px-3"><label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2 text-[14px] py-[10px]" for="grid-first-name" data-svelte-h="svelte-1ec8kr5">Product Name</label> <input class="appearance-none dark:bg-gray-700 block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3 border-[#dcdde0]" id="grid-first-name" type="text" placeholder="Cat Indo"${add_attribute("value", products.productName, 0)}></div> <div class="px-3"><label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2 text-[14px] py-[10px]" for="grid-last-name" data-svelte-h="svelte-1tx065q">Product Description</label> ${validate_component(Textarea, "Textarea").$$render(
      $$result,
      {
      ...
      {
        default: () => {
          return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true, title: "Seo Edit" }, {}, {
            default: () => {
          ...
          })} ${validate_component(TabItem, "TabItem").$$render($$result, { title: "Product Posts Edit" }, {}, {
            default: () => {
...
//# sourceMappingURL=CreateProduct-cf479779.js.map
