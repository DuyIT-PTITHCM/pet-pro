import { w as writable, d as derived } from './index-3be464aa.js';
import { g as get_store_value } from './utils-2dd7664d.js';
  ...
  loaders: [
    {
      locale: "en",
      key: "common",
      loader: async () => (await import('./common2-061c3d11.js')).default
    },
    {
      locale: "en",
      key: "header",
    ...
    },
    {
      locale: "en",
      key: "products",
      loader: async () => (await import('./products2-c58e249e.js')).default
    },
    {
      locale: "vi",
      key: "common",
      loader: async () => (await import('./common3-792c2fd6.js')).default
    },
    {
      locale: "vi",
      key: "header",
    ...
    },
    {
      locale: "vi",
      key: "products",
      loader: async () => (await import('./products3-2839861f.js')).default
    }
  ]
};
...
//# sourceMappingURL=index2-f9a9a751.js.map
