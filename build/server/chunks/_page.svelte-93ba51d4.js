...
import { v as validate_store, a as subscribe, h as is_promise, n as noop, e as compute_slots, j as null_to_empty } from './utils-6372ffc9.js';
...
import { H as HOST, B as BASE_API } from './Const-aff6847f.js';
...
const OurService = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="container m-auto"><div class="flex flex-col justify-center items-center px-3 relative w-full min-h-[80vh]"><h1 class="text-3xl mb-5 font-semibold dark:text-white" data-svelte-h="svelte-113kl75">Our Services</h1> <p class="mb-4 dark:text-white" data-svelte-h="svelte-1701gnf">Pets bring us joy and happiness, and we have a responsibility to take good care of them.</p> <div class="grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-4">${function(__value) {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Banner, "Banner").$$render($$result, {}, {}, {})} ${validate_component(Benefit, "Benefit").$$render($$result, {}, {}, {})} ${validate_component(OurTeam, "OurTeam").$$render($$result, {}, {}, {})} ${validate_component(OurService, "OurService").$$render($$result, {}, {}, {})} ${validate_component(ClientSay, "ClientSay").$$render($$result, {}, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-93ba51d4.js.map
