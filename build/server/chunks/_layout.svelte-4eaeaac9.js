import { v as validate_store, a as subscribe, f as set_store_value } from './utils-4ce9e277.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  set_store_value(me, $me = JSON.parse(localStorage.getItem("me") || ""), $me);
  console.log($me);
      ...
      {},
      {
        default: () => {
          return `${validate_component(DropdownHeader, "DropdownHeader").$$render($$result, {}, {}, {
            default: () => {
              return `<span class="block text-sm">${escape($me?.username)}</span> <span class="block truncate text-sm font-medium">${escape($me?.email)}</span>`;
            }
...
//# sourceMappingURL=_layout.svelte-4eaeaac9.js.map
