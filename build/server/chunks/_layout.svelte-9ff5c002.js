import { c as create_ssr_component, v as validate_component, e as escape, a as add_attribute, b as each, d as spread, f as escape_attribute_value, h as escape_object, g as getContext, s as setContext } from './ssr-ca1a55ab.js';
import { L as Loading, G as GradientButton } from './GradientButton-1986bcdb.js';
import { T as ToastError, D as DarkMode } from './ToastError-4a53f355.js';
import { v as validate_store, a as subscribe, c as is_promise, n as noop, d as compute_rest_props } from './utils-ea986cb1.js';
import { s as slide } from './index3-0ac21117.js';
import { I as Icon } from './Indicator.svelte_svelte_type_style_lang-b4bd0601.js';
import { M as Modal } from './Modal-8dc7bfed.js';
import { F as Frame } from './Frame-9bde659e.js';
import { twMerge } from 'tailwind-merge';
import { T as ToolbarButton } from './CloseButton-151cf4eb.js';
...
import { P as Popover } from './Popover-b2a2d1f4.js';
import { L as LanguageSelect } from './LanguageSelect-188a4823.js';
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function getCart() {
    ...
    totalCartQuantity = currentCart.reduce(
  ...
  do {
    ...
    $$rendered = `<div class="w-full relative"><div class="w-full" style="${"height: " + escape(heightHeader, true) + "px;"}"></div> <div class="w-full fixed top-0 z-50">${validate_component(Navbar, "Navbar").$$render($$result, { class: "shadow-md" }, {}, {
      default: ({ hidden, toggle }) => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        ...
        })} <div class="flex items-center lg:order-1"><a href="/login" title="Login"${add_attribute("class", classBtn, 0)}>${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:user", class: "scale-150" }, {}, {})}</a> <a class="${"relative " + escape(classBtn, true)}" href="/gio-hang">${validate_component(Icon, "Icon").$$render(
          $$result,
          {
          ...
          {},
          {}
        )} <span class="absolute top-0 right-0 rounded-xl h-[23px] w-[23px] bg-primary-600 text-white flex justify-center items-center p-2 text-base">${function(__value) {
        ...
        }(getCart())}</span></a> ${validate_component(DarkMode, "DarkMode").$$render($$result, { btnClass: classBtn }, {}, {})} ${validate_component(NavHamburger, "NavHamburger").$$render(
          $$result,
          {
          ...
          {
            hidden,
            divClass: "w-full lg:block md:w-auto",
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = ` <div id="ontop"></div> <div class="min-h-screen flex flex-col">${data.menu.length > 0 ? `${validate_component(Header, "Header").$$render(
      $$result,
      { menuProp: data.menu },
      {
        menuProp: ($$value) => {
      ...
      {}
    )}` : ``} <main>${slots.default ? slots.default({}) : ``}</main> <div class="mt-auto">${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div> ${validate_component(Loading, "Loading").$$render($$result, {}, {}, {})}</div> ${validate_component(ToastError, "ToastError").$$render($$result, {}, {}, {})} <a href="#ontop" class="p-4 bg-black bottom-0 right-0 fixed text-white rounded-full text-xl font-bold mb-3 mr-3 animate-spin z-50">${validate_component(Icon, "Icon").$$render($$result, { icon: "bxs:up-arrow" }, {}, {})}</a>`;
  } while (!$$settled);
  return $$rendered;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-9ff5c002.js.map
