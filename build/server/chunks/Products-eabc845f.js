              ...
              return `${validate_component(CarouselCustom, "CarouselCustom").$$render($$result, { perPage: 1, duration: 400 }, {}, {
                default: () => {
                  return `${each(res, (path, i) => {
                    return `<img${add_attribute("src", !path ? "/images/logo.png" : `${host}/` + path, 0)} class="rounded w-full mb-4 h-[350px] object-cover"${add_attribute("alt", product?.name, 0)}>`;
                  })} `;
                }
...
//# sourceMappingURL=Products-eabc845f.js.map
