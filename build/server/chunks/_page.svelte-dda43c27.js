import { c as create_ssr_component, v as validate_component, d as spread, h as escape_object, f as escape_attribute_value } from './ssr-33dc266f.js';
...
import { c as compute_rest_props } from './utils-83bdc9a3.js';
...
const SignUp = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    )}</div></form> <div class="absolute w-full h-full dark:brightness-50 transition-all" data-svelte-h="svelte-1xss5m1"><img class="w-full h-full object-cover" src="/images/signupbg.jpg" alt=""></div></div> ${validate_component(ToastCustom, "ToastCustom").$$render(
      $$result,
...
//# sourceMappingURL=_page.svelte-dda43c27.js.map
