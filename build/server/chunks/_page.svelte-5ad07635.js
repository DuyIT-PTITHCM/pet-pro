import { c as create_ssr_component, v as validate_component, a as each, e as escape, b as add_attribute } from './ssr-01008541.js';
...
import { C as Checkbox } from './Checkbox-628266b2.js';
import { g as getAllQueryParams, q as queryParamsToObject, T as Table, a as TableHead, b as TableHeadCell, c as TableBody, d as TableBodyRow, e as TableBodyCell, P as Pagination, u as updateQueryParams } from './queryParams-96182754.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="header-manager bg-slate-100 dark:bg-slate-900 p-10 my-4 rounded-xl"><div class="flex items-center justify-between"><h1 class="dark:text-white 2xl:text-4xl xl:text-3xl lg:text-3xl md:text-lg sm:text-lg text-lg font-bold" data-svelte-h="svelte-1n3g2kr">Blog Management</h1> <div class="flex gap-1"><a href="./blog/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" data-svelte-h="svelte-1lnohhv">Filter</a> <a href="./blog/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" data-svelte-h="svelte-1wrhjwf">Create Blog</a></div></div></div>  ${validate_component(Table, "Table").$$render(
    $$result,
    {
      hoverable: true,
...
//# sourceMappingURL=_page.svelte-5ad07635.js.map
