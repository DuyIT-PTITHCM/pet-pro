import { c as create_ssr_component, v as validate_component, a as add_attribute } from './ssr-31a8ce1b.js';
import { B as Button } from './Button-79a23070.js';
import './Icon-d5159527.js';
import { D as DarkMode } from './Wrapper-222fb707.js';
import { L as Label, C as Checkbox } from './Checkbox-c190b3df.js';
import { I as Input, H as Helper, T as ToastCustom } from './ToastCustom-a077be88.js';
import 'js-cookie';
...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })} <a href="/signup" class="text-primary-600 dark+:text-primary-500 hover:underline font-bold text-sm text-right w-full block" data-svelte-h="svelte-1kfjhtd">Sign up for Pet One</a></form></div></div> <div class="absolute w-full h-full dark:brightness-50 transition-all"><img class="w-full h-full object-cover"${add_attribute("src", "/images/loginbg.jpg", 0)} alt=""></div></div> ${validate_component(ToastCustom, "ToastCustom").$$render(
      $$result,
...
//# sourceMappingURL=_page.svelte-12962f6a.js.map
