import { s as subscribe, c as compute_rest_props } from './utils-83bdc9a3.js';
import { c as create_ssr_component, e as escape, a as add_attribute, v as validate_component, b as each, d as spread, f as escape_attribute_value, h as escape_object, g as getContext, s as setContext } from './ssr-33dc266f.js';
import { D as DarkMode } from './Wrapper-dcaf300d.js';
import { t as title, d as description } from './meta-7f8c71df.js';
import { A as Avatar, D as Dropdown, a as DropdownHeader, b as DropdownItem, c as DropdownDivider, M as Modal, F as Frame } from './Modal-b7ee1433.js';
import { G as GradientButton } from './GradientButton-6ef4e81f.js';
import { I as Icon } from './Icon-2596fab7.js';
import { twMerge } from 'tailwind-merge';
import { T as ToolbarButton, q as quintOut } from './CloseButton-0f477096.js';
import { B as Button, i as is_void } from './Button-bc7f9417.js';
import { g as getCookie } from './cookieUtils-3c057440.js';
import { w as writable } from './index2-afe1f66f.js';
...
const NavHamburger = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { btnClass: btnClass2 = "ml-3 md:hidden" } = $$props;
  ...
  return `${validate_component(ToolbarButton, "ToolbarButton").$$render($$result, Object.assign({}, { name: "Open main menu" }, $$restProps, { class: twMerge(btnClass2, $$props.class) }), {}, {
    default: () => {
...
const css$1 = {
  code: "select.svelte-1q28iul{outline:none;border:none;padding:0 24px;cursor:pointer;border-radius:100px}select.svelte-1q28iul:hover{opacity:.9}",
  map: null
};
const LanguageSelect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `   <select class="dark:bg-slate-800 svelte-1q28iul">${each(languages, (language) => {
    ...
    $$rendered = `<div class="w-full relative h-auto"><div class="w-full fixed top-0 z-50">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
      default: ({ hidden, toggle }) => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
          default: () => {
            return `<img src="/images/logo.png" class="mr-3 h-7 sm:h-9 shadow rounded-full bg-gray-50 dark:bg-transparent" alt="PetOne Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-17h157z">PetOne</span>`;
          }
...
const css = {
  code: ".footer-list.svelte-1fx8iq4 a.svelte-1fx8iq4{display:block;width:100%;padding:10px 30px;border-radius:10px;display:flex;align-items:center;text-transform:capitalize}.footer-list.svelte-1fx8iq4 a.svelte-1fx8iq4:hover{box-shadow:0 4px 4px rgba(255, 255, 255, 0.3) inset, 0 -4px 4px rgba(255, 255, 255, 0.3) inset;transition:box-shadow .6s;font-weight:600}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    )}</div> <div class="bg-black bg-opacity-80 w-full rounded-lg sm:col-span-1"><ul class="text-white footer-list svelte-1fx8iq4"><ol class="border-b-2 border-white border-opacity-30 rounded-lg py-2 px-6 uppercase text-xl font-semibold" data-svelte-h="svelte-8k6n91">service</ol> ${each(services, (item) => {
      return `<li><a${add_attribute("href", item.url, 0)} class="svelte-1fx8iq4">${escape(item.name)}</a></li>`;
    })}</ul></div> <div class="bg-black bg-opacity-80 w-full rounded-lg"><ul class="text-white footer-list svelte-1fx8iq4"><ol class="border-b-2 border-white border-opacity-30 rounded-lg py-2 px-6 uppercase text-xl font-semibold" data-svelte-h="svelte-2ueqxx">company</ol> ${each(legal, (item) => {
      return `<li><a${add_attribute("href", item.url, 0)} class="svelte-1fx8iq4">${escape(item.name)}</a></li>`;
    })}</ul></div> <div class="bg-black bg-opacity-80 w-full rounded-lg"><ul class="text-white footer-list svelte-1fx8iq4"><ol class="border-b-2 border-white border-opacity-30 rounded-lg py-2 px-6 uppercase text-xl font-semibold" data-svelte-h="svelte-u6pxlt">social</ol> ${each(social, (item) => {
      return `<li><a${add_attribute("href", item.url, 0)} class="svelte-1fx8iq4">${validate_component(Icon, "Icon").$$render(
        $$result,
        {
    ...
    })}</ul></div></div> <div class="w-full absolute bottom-0 bg-black bg-opacity-50 mx-auto p-4 md:flex md:items-center md:justify-between" data-svelte-h="svelte-ult779"><span class="text-sm text-white sm:text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">PawCat™</a>. All Rights Reserved.</span></div></div></div> </footer>`;
  } while (!$$settled);
  return $$rendered;
});
...
//# sourceMappingURL=_layout.svelte-6f46d99a.js.map
