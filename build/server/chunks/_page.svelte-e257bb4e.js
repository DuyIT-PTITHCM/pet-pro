...
import { T as Tabs, a as TabItem } from './CreateSeo-912e2985.js';
import { C as CreateProduct } from './CreateProduct-9b64d0f6.js';
import { M as MODE_MODIFY, H as HOST } from './Const-aff6847f.js';
import { c as convertImageJsonToArray } from './common3-0496d5da.js';
                ...
                default: () => {
                  return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true, title: "Seo Information" }, {}, {
                    ...
                    default: () => {
                      ...
                      })}</div></div></div>  <div class="py-[20px] justify-center"><h3 data-svelte-h="svelte-1x74cpg">Content Posts</h3> <br> <div class="dark:text-gray-100"><!-- HTML_TAG_START -->${product?.post?.content}<!-- HTML_TAG_END --></div></div>` : `${validate_component(Nodata, "Nodata").$$render($$result, {}, {}, {})}`}`;
                    }
                  })}`;
                }
              }
...
//# sourceMappingURL=_page.svelte-e257bb4e.js.map
