...
`;
    ...
    return function(res) {
      return ` <div class="container m-auto my-[100px] px-2"><img src="https://siliconstack.com.au/wp-content/uploads/2019/09/Working-process.png" alt=""></div> ${validate_component(HeaderPage, "HeaderPage").$$render(
        ...
        {},
        {}
      )} <div class="container m-auto my-[100px] px-2 z-50"><div class="grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-4">${validate_component(OurService, "OurService").$$render($$result, { data: res?.servicesLasted }, {}, {})}</div></div> ${validate_component(HeaderPage, "HeaderPage").$$render(
        $$result,
        {
          title: "Our product",
...
//# sourceMappingURL=_page.svelte-c3537bd9.js.map
