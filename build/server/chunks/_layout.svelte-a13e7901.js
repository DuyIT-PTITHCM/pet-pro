import { c as create_ssr_component, e as escape, a as add_attribute, v as validate_component, b as each, d as spread, g as escape_object, f as escape_attribute_value } from './ssr-1bb711e0.js';
import { I as Icon } from './Icon-ac1f5dfd.js';
import { s as sineIn, A as Avatar, C as CloseButton } from './Avatar-9049e27b.js';
...
import { D as Dropdown, a as DropdownHeader, b as DropdownItem, c as DropdownDivider, M as Modal } from './Modal-bbbaaca4.js';
import { L as Label, C as Checkbox } from './Checkbox-01f54b15.js';
import { c as compute_rest_props, a as compute_slots } from './utils-5d10fb30.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${"admin-header " + escape("", true) + " bg-slate-100 dark:bg-slate-900 s-i2ZroYsgAmjD"}"><div class="admin-header-box admin-header__left s-i2ZroYsgAmjD"><div class="logo-dashboard flex px-4" style="${"min-width:" + escape(sidebarWidth, true) + "px;"}"><img src="https://static.vecteezy.com/system/resources/previews/009/551/676/original/shy-dog-logo-illustration-depicting-shy-dog-suitable-for-pet-company-free-vector.jpg" class="mr-3 h-6 sm:h-9 rounded-full" alt="PetOne Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-17h157z">PetOne</span></div> <div class="${"hide-sidebar cursor-pointer " + escape(btnClass, true) + " s-i2ZroYsgAmjD"}"><input type="checkbox" class="hidden" name="hidesidebar" id="hidesidebar"${add_attribute("checked", isHide, 1)}> <label for="hidesidebar">${validate_component(Icon, "Icon").$$render(
      ...
      return `<li><a class="${"admin-sidebar__item min-w-max " + escape(item.active == true ? "active" : "", true) + " s-i2ZroYsgAmjD"}"${add_attribute("href", item.url, 0)}>${validate_component(Icon, "Icon").$$render($$result, { class: "text-3xl  mr-2", icon: item.icon }, {}, {})}${escape(item.name)}</a> </li>`;
    })}`}</ul></div> <div class="admin-content-box s-i2ZroYsgAmjD" style="${"--deg: " + escape(degString, true) + "; --gradient-1:" + escape(colors[0], true) + "; --gradient-2:" + escape(colors[1], true) + ";"}"><div class="m-4">${slots.default ? slots.default({}) : ``}</div></div> </div>`;
  } while (!$$settled);
  return $$rendered;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-a13e7901.js.map
