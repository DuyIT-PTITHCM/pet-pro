...
import { c as create_ssr_component, s as setContext, a as add_attribute, d as spread, h as escape_object, f as escape_attribute_value, g as getContext, e as escape, b as each } from './ssr-6197c9bb.js';
...
const Pagination = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${totalPages > 1 ? `<div class="pagination flex justify-center items-center mt-20"><button class="${"mx-1 px-2 py-1 border border-gray-300 rounded bg-white dark:bg-gray-800 dark:text-white " + escape(
...
//# sourceMappingURL=queryParams-9df50fb7.js.map
