...
import { c as create_ssr_component, e as escape, a as add_attribute, v as validate_component, b as each, d as spread, h as escape_object, f as escape_attribute_value } from './ssr-8dc8d8d7.js';
import { D as DarkMode } from './DarkMode-8d6d8a24.js';
import { I as Icon } from './Icon-c5f05f08.js';
import { s as sineIn, M as Modal, C as CloseButton } from './Modal-e4e8d0fd.js';
...
import { T as ToastError } from './ToastError-aa57214a.js';
import './Wrapper-4d73308a.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })}`}</ul></div> <div class="admin-content-box flex-auto s-i2ZroYsgAmjD" style="${"--deg: " + escape(degString, true) + "; --gradient-1:" + escape(colors[0], true) + "; --gradient-2:" + escape(colors[1], true) + ";"}"><div class="m-4">${slots.default ? slots.default({}) : ``}</div></div></div> ${validate_component(ToastError, "ToastError").$$render($$result, {}, {}, {})}`;
  } while (!$$settled);
  $$unsubscribe_title();
...
//# sourceMappingURL=_layout.svelte-e8783581.js.map
