      ...
      {},
      {
        default: () => {
          return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true, title: "Seo" }, {}, {
            ...
            default: () => {
              return `<div class="grid 2xl:grid-cols-1 xl:grid-cols-1 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 gap-5">${validate_component(Editor, "Editor").$$render(
                $$result,
                {
                ...
                {}
              )} <h1><!-- HTML_TAG_START -->${text}<!-- HTML_TAG_END --></h1></div>`;
            }
          })}`;
        }
      }
