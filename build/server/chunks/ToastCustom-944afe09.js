...
import { c as create_ssr_component, g as getContext, v as validate_component, e as escape, d as spread, h as escape_object, f as escape_attribute_value, a as add_attribute, b as each } from './ssr-9152e219.js';
import { W as Wrapper } from './Wrapper-2cae54fd.js';
...
const ToastCustom = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="z-50 fixed top-20 right-4 flex flex-col-reverse items-end">${each(toasts, (toast) => {
    return `${toast.visible ? `<div class="${"toast text-white p-2 rounded-md flex items-center gap-4 mb-2 " + escape(messageType, true) + " s-8qAUd7lXYtIE"}"><p class="flex items-center 2xl:text-base xl:text-base lg:text-base md:text-base sm:text-xs text-xs">${validate_component(Icon, "Icon").$$render(
      $$result,
      {
        class: "text-3xl",
...
//# sourceMappingURL=ToastCustom-944afe09.js.map
