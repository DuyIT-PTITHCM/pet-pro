...
import { c as create_ssr_component, v as validate_component, b as each, e as escape, a as add_attribute } from './ssr-0d75b2b1.js';
  ...
  return `${function(__value) {
    ...
    return function(res) {
      return ` <ul class="list-none leading-7 sm:text-base text-sm overflow-y-auto"><li class="uppercase text-base font-semibold border-b-2 dark:border-gray-600 mb-2 text-center p-3" data-svelte-h="svelte-1jbfhih">contents</li> ${each(menus, (item) => {
        return `<li> <a href="#" class="line-clamp-1 text-blue-600 dark:text-blue-500 hover:text-primary-600 dark:hover:text-primary-500">${escape(item.value)}</a> </li>`;
      })}</ul> `;
    }();
  }(getHeading(menus))}`;
});
...
//# sourceMappingURL=SideMenuHeading-9d2aa096.js.map
