import { c as create_ssr_component, v as validate_component, e as escape, a as each, b as add_attribute, d as spread, f as escape_attribute_value, h as escape_object, g as getContext, s as setContext } from './ssr-8f3207f5.js';
...
import { P as Popover, s as slide } from './Popover-1aa14597.js';
...
import { M as Modal, T as ToolbarButton, q as quintOut } from './Modal-ac6c7526.js';
                        ...
                        default: () => {
                          return `${each(item.subMenus, (sub) => {
                            return `<button class="${"block w-full p-4 " + escape(
                              sub.active == false && numACtiveMenu == sub.id ? "dark:text-white text-primary-600 font-bold" : "hover:text-primary-700 dark:text-slate-400 dark:hover:text-white",
                              true
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-1g5qsit_START -->${$$result.title = `<title>Trang chủ - Cửa hàng thú cưng Pet One</title>`, ""}<meta name="description" content="Cửa hàng thú cưng chuyên cung cấp các sản phẩm và dịch vụ cho thú cưng của bạn."><link rel="canonical" href="http://103.142.26.42/"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="robots" content="index, follow"><meta charset="UTF-8"><meta property="og:title" content="Trang chủ - Cửa hàng thú cưng Pet One"><meta property="og:description" content="Cửa hàng thú cưng chuyên cung cấp các sản phẩm và dịch vụ cho thú cưng của bạn."><meta property="og:image" content="/images/logo.png"><meta property="og:url" content="http://103.142.26.42/"><link rel="icon" href="/favicon.ico" type="image/x-icon"><!-- HEAD_svelte-1g5qsit_END -->`, ""} ${data.menu.length > 0 ? `${validate_component(Header, "Header").$$render(
      $$result,
      { menuProp: data.menu },
      {
        menuProp: ($$value) => {
...
//# sourceMappingURL=_layout.svelte-260b3cc9.js.map
